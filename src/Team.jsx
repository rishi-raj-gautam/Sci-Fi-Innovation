...
function Team() {
    ...
    useEffect(() => {
        ...
        const fetchTeamMembers = async () => {
            const data = [
                { id: 1, name: "JOHN DOE", role: "Fullstack dev & UX UI", photo: "/path-to-photo1.jpg" },
                { id: 2, name: "JANE SMITH", role: "Backend Developer", photo: "/path-to-photo2.jpg" },
                { id: 3, name: "ROBERT BROWN", role: "Frontend Developer", photo: "/path-to-photo3.jpg" }
            ];
            setTeamMembers(data);
        };
